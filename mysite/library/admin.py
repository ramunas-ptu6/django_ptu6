...
class BookAdmin(admin.ModelAdmin):
    list_display = (
    'title', 'author', 'display_genre', 'get_authname')  # nurodom kokius stulpelius vaizduosime BookInstance
...
class BookInstanceAdmin(admin.ModelAdmin):
    ...
    list_editable = (
    'due_back', 'status', 'reader')  # nurodom kad į list_display įtraukti stulpeliai gali būti redaguojami
